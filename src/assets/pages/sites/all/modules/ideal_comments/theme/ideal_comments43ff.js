    ...
    attach: function (context, settings) {
        ...
        $('#comments')
          ...
          .append(
            '<div class="show-all-comments">' +
              Drupal.t('Show all comments') +
              '</div><div class="show-all-comments less hidden">' +
              Drupal.t('Show less comments') +
              '</div>'
          );
      ...
      $('#comments .indented').once(function () {
        ...
        $(this)
          ...
          .find('.content')
          .after(
            '<div class="comment_show right">' + child_count + ' ' + Drupal.t('Comments to this comment') + '</div>'
          );
      });

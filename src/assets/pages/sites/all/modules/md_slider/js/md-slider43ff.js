  ...
  e.fn.mdSlider = function (r) {
      ...
      s.find('.' + r.itemClassName).each(function (t) {
        ...
        e(this)
          ...
          .each(function () {
            ...
            var o = { top: (t / r.height) * 100 + '%', left: (n / r.width) * 100 + '%' };
            e(this).css(o);
          });
        if (t > 0) e(this).hide();
      });
        ...
        if (r.videoBox) {
          ...
          e('.md-video', p).click(function () {
            ...
            t.attr('allowFullScreen', '')
              .attr('frameborder', '0')
              .css({ width: '100%', height: '100%', background: 'black' });
          ...
          for (var u = 0; u < f; u++) {
            ...
            if (c) {
              ...
              if (h == 'image')
                v = e('<img />')
                  .attr('src', c)
                  .css({ top: -(9 + l) + 'px', left: -(a / 2 - 2) + 'px', opacity: 0 });
              else
                v = e('<span></span>')
                  .attr('style', c)
                  .css({ top: -(9 + l) + 'px', left: -(a / 2 - 2) + 'px', opacity: 0 });
              e('div.md-bullet:eq(' + u + ')', g)
                .append(v)
                .append('<div class="md-thumb-arrow" style="opacity: 0"></div>');
            }
          }
          e('div.md-bullet', g).hover(
            function () {
              e(this).addClass('md_hover');
              e('img, span', this).show().animate({ opacity: 1 }, 200);
              e('.md-thumb-arrow', this).show().animate({ opacity: 1 }, 200);
            },
            function () {
              e(this).removeClass('md_hover');
              e('img, span', this).animate({ opacity: 0 }, 200, function () {
                e(this).hide();
              });
              e('.md-thumb-arrow', this).animate({ opacity: 0 }, 200, function () {
                e(this).hide();
              });
            }
          );
    ...
    function P() {
      if (v) {
        ...
        d.hover(
          function () {
            if (m) {
              m.stop(true, true).animate({ opacity: 1 }, 200);
            }
          },
          function () {
            if (m) {
              m.stop(true, true).animate({ opacity: 0 }, 200);
            }
          }
        );
        p.trigger('hover');
          ...
          if (v) {
            ...
            w.bind('touchend', function (t) {
              ...
              if (Math.abs(t.pageX - this.mouseX) < r.touchSensitive) {
                ...
                w.stop(true, true).animate({ left: s }, 400);
                return false;
              }
              if (w.position().left < E) {
                w.stop(true, true).animate({ left: E }, 400, function () {
                  j();
                });
              } else if (w.position().left > 0) {
                w.stop(true, true).animate({ left: 0 }, 400, function () {
                  j();
                });
              }
              s = 0;
      ...
      if (w) {
        if (t == 'left') {
          ...
          if (n > E) {
            ...
            if (n - r > E) {
              w.stop(true, true).animate({ left: n - r }, 400, function () {
                j();
              });
            } else {
              w.stop(true, true).animate({ left: E }, 400, function () {
          ...
          if (i >= 0) {
            ...
            var s = i * e('a', w).width();
            if (s + n < 0) {
              w.stop(true, true).animate({ left: -s }, 400, function () {
                j();
              });
            } else {
              var o = s + e('a', w).width();
              var r = e('.md-thumb-container', p).width();
              if (o + n > r) {
                w.stop(true, true).animate({ left: r - o }, 400, function () {
                  j();
                });
              }
            }
    ...
    function F(t) {
      ...
      if (o[u]) {
        ...
        if (
          ...
          (i == 'slit-horizontal-left-top' ||
            i == 'slit-horizontal-top-right' ||
            i == 'slit-horizontal-bottom-up' ||
            i == 'slit-vertical-down' ||
            i == 'slit-vertical-up')
        ) {
          i = 'fade';
        }
    ...
    function J(t, n) {
      ...
      for (var d = 0; d < n.strips; d++) {
        ...
        i = e('<div class="mdslider-strip"></div>')
          .css({ width: g, height: y, top: v, left: m, opacity: 0 })
          .append(p.clone().css({ marginLeft: t ? 0 : -(d * f) + 'px', marginTop: t ? -(d * h) + 'px' : 0 }));
        u.append(i);
      }
      s.append(u);
    }
    function K(t, n, r) {
      ...
      for (var p = 0; p < n; p++) {
        for (var d = 0; d < t; d++) {
          var v = f * p + 'px',
            m = a * d + 'px';
          i = e('<div class="mdslider-tile"/>')
            .css({ width: a, height: f, top: v, left: m })
            .append(h.clone().css({ marginLeft: '-' + m, marginTop: '-' + v }));
          u.append(i);
        }
      }
      s.append(u);
    ...
    function Q() {
      ...
      for (var i = 0; i < 2; i++) {
        t = e('<div class="mdslider-strip"></div>').css({ width: l, height: c }).append(n[i].clone());
        r.append(t);
      }
      s.append(r);
    }
    function G(t) {
      ...
      if (t == 'slit-vertical-down' || t == 'slit-vertical-up')
        a = e('<div class="mdslider-slit"/>').append(r.clone().css('left', f.left - l / 2 + 'px'));
      n.append(i).append(a);
      s.append(n);
    }
    function Y(t) {
      switch (t) {
        ...
        case 'strip-up-left':
          ...
          p.css({ height: '1px', bottom: '0px', top: 'auto' });
          p.each(function (t) {
            var n = e(this);
            setTimeout(function () {
              n.animate({ height: '100%', opacity: '1.0' }, v, 'easeInOutQuart', function () {
        ...
        case 'strip-down-left':
          ...
          p.css({ height: '1px', top: '0px', bottom: 'auto' });
          p.each(function (t) {
            var n = e(this);
            setTimeout(function () {
              n.animate({ height: '100%', opacity: '1.0' }, v, 'easeInOutQuart', function () {
        ...
        case 'strip-left-down':
          ...
          p.css({ width: '1px', left: '0px', right: 'auto' });
          p.each(function (t) {
            var n = e(this);
            setTimeout(function () {
              n.animate({ width: '100%', opacity: '1.0' }, v, 'easeInOutQuart', function () {
        ...
        case 'strip-right-down':
          ...
          p.css({ width: '1px', left: 'auto', right: '1px' });
          p.each(function (t) {
            var n = e(this);
            setTimeout(function () {
              n.animate({ width: '100%', opacity: '1.0' }, v, 'easeInOutQuart', function () {
        ...
        case 'strip-right-left-down':
          ...
          p.filter(':odd')
            .css({ width: '100%', right: '0px', left: 'auto', opacity: 1 })
            .end()
            .filter(':even')
            .css({ width: '100%', right: 'auto', left: '0px', opacity: 1 });
          p.each(function (t) {
            var n = e(this);
            var i = t % 2 == 0 ? { left: '-50%', opacity: '0' } : { right: '-50%', opacity: '0' };
            setTimeout(function () {
        ...
        case 'strip-up-down-left':
          ...
          p.filter(':odd')
            .css({ height: '100%', bottom: '0px', top: 'auto', opacity: 1 })
            .end()
            .filter(':even')
            .css({ height: '100%', bottom: 'auto', top: '0px', opacity: 1 });
          p.each(function (t) {
            var n = e(this);
            var i = t % 2 == 0 ? { top: '-50%', opacity: 0 } : { bottom: '-50%', opacity: 0 };
            setTimeout(function () {
              n.animate(i, v, 'easeOutQuint', function () {
                if (t == r.stripCols - 1) {
                  r.onEndTransition.call(s);
        ...
        case 'left-curtain':
          ...
          p.each(function (t) {
            var n = e(this);
            n.css({ left: m * t, width: 0, opacity: 0 });
            setTimeout(function () {
              n.animate({ width: m, opacity: '1.0' }, r.transitionsSpeed / 2, function () {
                if (t == r.stripCols - 1) V();
              });
            }, d * t);
          });
        ...
        case 'right-curtain':
          ...
          p.each(function (t) {
            var n = e(this);
            n.css({ right: m * t, left: 'auto', width: 0, opacity: 0 });
            setTimeout(function () {
              n.animate({ width: m, opacity: '1.0' }, r.transitionsSpeed / 2, function () {
                if (t == r.stripCols - 1) V();
              });
        ...
        case 'top-curtain':
          ...
          p.each(function (t) {
            var n = e(this);
            n.css({ top: g * t, height: 0, opacity: 0 });
            setTimeout(function () {
              n.animate({ height: g, opacity: '1.0' }, r.transitionsSpeed / 2, function () {
                if (t == r.stripRows - 1) V();
              });
            }, d * t);
          });
        ...
        case 'bottom-curtain':
          ...
          p.each(function (t) {
            var n = e(this);
            n.css({ bottom: g * t, height: 0, opacity: 0 });
            setTimeout(function () {
              n.animate({ height: g, opacity: '1.0' }, r.transitionsSpeed / 2, function () {
                if (t == r.stripRows - 1) V();
              });
        ...
        case 'slide-in-right':
          ...
          p.each(function () {
            ...
            var t = y * l;
            w.css({ left: t });
            w.animate({ left: t - l }, r.transitionsSpeed, function () {
              V();
            });
            y++;
          });
        ...
        case 'slide-in-left':
          ...
          p.each(function () {
            ...
            var t = -y * l;
            w.css({ left: t });
            w.animate({ left: l + t }, r.transitionsSpeed * 2, function () {
              V();
            });
            y++;
          });
        ...
        case 'slide-in-up':
          ...
          p.each(function () {
            ...
            var t = y * c;
            w.css({ top: t });
            w.animate({ top: t - c }, r.transitionsSpeed, function () {
              V();
            });
            y++;
          });
        ...
        case 'slide-in-down':
          ...
          p.each(function () {
            ...
            var t = -y * c;
            w.css({ top: t });
            w.animate({ top: c + t }, r.transitionsSpeed, function () {
              V();
            });
            y++;
          });
        ...
        default:
          ...
          w.css({ height: '100%', width: l });
          if (t == 'slide-in-right') w.css({ height: '100%', width: l, left: l + 'px', right: '' });
          else if (t == 'slide-in-left') w.css({ left: '-' + l + 'px' });
          w.animate({ left: '0px', opacity: 1 }, r.transitionsSpeed, function () {
            V();
          });
          break;
      }
    ...
    function tt() {
      ...
      if (!r.responsive && r.fullwidth) p.css({ 'min-width': l + 'px' });
      if (r.fullwidth) {
        e('.md-objects', s).width(r.width);
        var t = 20;
        if ((p.width() - r.width) / 2 > 20) t = (p.width() - r.width) / 2;
        p.find('.md-bullets').css({ left: t, right: t });
        p.find('.md-thumb').css({ left: t, right: t });
      }
      ...
      e('.md-slide-item .md-mainimg img', s).each(function () {
        e(this).load(function () {
          ...
          if (!t.data('defW')) {
            ...
            t.data({ defW: n.width, defH: n.height });
          }
    ...
    function st(t, n, r) {
      ...
      if (r > 0 && o > 0) {
        if (n / r > i / o) {
          var u = i - (o / r) * n;
          t.css({ width: 'auto', height: o + 'px' });
          if (u < 0) {
            t.css({ left: u / 2 + 'px', top: 0 });
          } else {
            t.css({ left: 0, top: 0 });
          }
        } else {
          var a = o - (i / n) * r;
          t.css({ width: i + 'px', height: 'auto' });
          if (a < 0) {
            t.css({ top: a / 2 + 'px', left: 0 });
          } else {
            t.css({ left: 0, top: 0 });
          }
        }
    ...
    function ot() {
      ...
      if (p.width() < r.width) {
        e('.md-objects', s).css({ 'font-size': (p.width() / r.width) * 100 - t + '%' });
      } else {
        e('.md-objects', s).css({ 'font-size': 100 - t + '%' });
      }
    }
    function ut() {
    ...
    function at() {
      if (r.showThumb && !r.showBullet) {
        ...
        if (r.posThumb == '1') {
          ...
          p.find('.md-thumb').css({ height: thumbHeight + 10, bottom: -thumbBottom - 10 });
          p.css({ 'margin-bottom': thumbBottom + 10 });
        } else {
          p.find('.md-thumb').css({ height: thumbHeight + 10, bottom: -(thumbHeight + 40) });
          p.css({ 'margin-bottom': thumbHeight + 50 });
        }
      }
    }
    function ft(e) {

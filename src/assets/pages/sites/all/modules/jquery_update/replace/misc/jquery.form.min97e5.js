...
(function (a) {
  ...
  (a.fn.ajaxSubmit = function (c) {
    function r() {
      function t() {
        if (!j.aborted) {
          ...
          try {
            ...
            (j.responseText = c.body ? c.body.innerHTML : c.documentElement ? c.documentElement.innerHTML : null),
          ...
          j.aborted && (b('upload aborted'), (d = !1)),
            d && (e.success && e.success.call(e.context, q, 'success', j), k && a.event.trigger('ajaxSuccess', [j, e])),
            k && a.event.trigger('ajaxComplete', [j, e]),
            k && !--a.active && a.event.trigger('ajaxStop'),
            e.complete && e.complete.call(e.context, j, d ? 'success' : 'error'),
            setTimeout(function () {
      ...
      function p() {
        ...
        d.setAttribute('target', f),
          d.getAttribute('method') != 'POST' && d.setAttribute('method', 'POST'),
          d.getAttribute('action') != e.url && d.setAttribute('action', e.url),
          e.skipEncodingOverride || l.attr({ encoding: 'multipart/form-data', enctype: 'multipart/form-data' }),
          e.timeout &&
            setTimeout(function () {
              (m = !0), t();
            }, e.timeout);
        ...
        try {
          ...
          h.appendTo('body'),
            i.attachEvent ? i.attachEvent('onload', t) : i.addEventListener('load', t, !1),
            d.submit();
        } finally {
      ...
      if (a(':input[name=submit],:input[id=submit]', d).length)
        ...
        if (n) {
          ...
          o &&
            ...
            n.type == 'image' && ((e.extraData[o + '.x'] = d.clk_x), (e.extraData[o + '.y'] = d.clk_y)));
        }
        ...
        var q,
          ...
          w = function (b, c, d) {
            ...
            f && g.documentElement.nodeName === 'parsererror' && a.error && a.error('parsererror'),
              d && d.dataFilter && (g = d.dataFilter(g, c)),
              typeof g == 'string' &&
                (c === 'json' || (!c && e.indexOf('json') >= 0)
                  ? (g = v(g))
                  : (c === 'script' || (!c && e.indexOf('javascript') >= 0)) && a.globalEval(g));
            return g;
          };
      }
    }
    ...
    if (c.data) {
      c.extraData = c.data;
      for (g in c.data)
        if (c.data[g] instanceof Array) for (var j in c.data[g]) i.push({ name: g, value: c.data[g][j] });
    ...
    c.iframe !== !1 && (o || c.iframe || q) ? (c.closeKeepAlive ? a.get(c.closeKeepAlive, r) : r()) : a.ajax(c),
    ...
    (a.fn.formToArray = function (b) {
      ...
      for (f = 0, k = e.length; f < k; f++) {
        ...
        i = a.fieldValue(j, !0);
        if (i && i.constructor == Array) for (g = 0, l = i.length; g < l; g++) c.push({ name: h, value: i[g] });

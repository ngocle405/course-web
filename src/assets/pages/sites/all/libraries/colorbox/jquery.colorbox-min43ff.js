...
(function (t, e, i) {
  ...
  function f(i) {
    ...
    if (!G) {
      ...
      v
        .css({ opacity: p === p ? p : '', cursor: _.get('overlayClose') ? 'pointer' : '', visibility: 'visible' })
        .show(),
    ...
    ce = (function () {
      ...
      return function () {
        r
          ...
          : _.get('slideshow') && W[1] && ((r = !0), ae.one(oe, o), _.get('slideshowAuto') ? i() : n(), R.show());
      };
    })();
  t[Y] ||
    (t(p),
            ...
            $ &&
              ...
              _.get('iframe')
                ? ((n = e.createElement('iframe')),
                  ...
                  t(n)
                    .attr({ src: _.get('href'), name: new Date().getTime(), class: Z + 'Iframe', allowFullScreen: !0 })
                    .one('load', o)
                    .appendTo(L),
                  ae.one(he, function () {
                    n.src = '//about:blank';
